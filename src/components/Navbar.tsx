              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-9 h-9 border-2 border-[var(--border-base)] flex items-center justify-center text-[var(--text-muted)] hover:border-[var(--brand-mint)] hover:text-[var(--brand-mint)] transition-all duration-200"
                  >
