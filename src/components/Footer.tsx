...
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--bg-base)] border-t border-[var(--border-base)]">
      <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          >
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full border border-[var(--border-base)] flex items-center justify-center text-[var(--text-muted)] hover:border-[var(--brand-mint)] hover:text-[var(--brand-mint)] transition-all duration-150"
              >
        ...
        <div className="border-t border-[var(--border-base)] pt-6 mt-12 flex flex-col md:flex-row justify-between items-center gap-4">
